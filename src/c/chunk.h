...
static chunk chunk_new(dtype dtype, s32 depth, s32 height, s32 width);
static void chunk_free(chunk* chunk);
static chunk chunk_cast(chunk* chunk, dtype dtype);

static u8 chunk_get_u8(chunk* chunk, s32 z, s32 y, s32 x);
static f32 chunk_get_f32(chunk* chunk, s32 z, s32 y, s32 x);
static void chunk_set_u8(chunk* chunk, s32 z, s32 y, s32 x, u8 val);
static void chunk_set_f32(chunk* chunk, s32 z, s32 y, s32 x, f32 val);
...
static void chunk_free(chunk* chunk) { free(chunk->data); }
